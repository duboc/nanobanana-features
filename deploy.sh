...
echo "    1. Run ./setup-iap.sh to configure OAuth consent screen & allowed domains"
echo "    2. Run ./configure-iap.sh to grant access to google.com domain"
echo "    3. Visit ${SERVICE_URL} and sign in with your @google.com account"
echo ""
